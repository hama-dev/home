...
class RequestGroup extends React.Component {
  state = {
  ...
  AcceptRequestHandler = () => {
    ...
    this.props.StartAcceptTheRequest(this.state.requestId, this.state.userId , now );
  };
  ...
  onRejectSubmitHandler = e => {
    ...
    if (msg) {
      this.props
        .StartRejectTheRequest(this.state.requestId, this.state.userId, msg , now)
        .then(() => {
